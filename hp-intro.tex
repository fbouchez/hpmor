...
\thispagestyle{empty}
{\hpfont
\Huge\MakeUppercase{Harry Potter}\vspace*{0.45cm}

\Large\MakeUppercase{et les Méthodes de la Rationalité} %

\includegraphics[scale=0.45]{bubble.pdf}
...
Traduction originale~: AdrienH\\
Traduction revisitée~: Florent Bouchez Tichadou\\
