...
Harry hocha la tête d'un air lugubre.
...
Ce que Harry \emph{voulait} faire, c'était en parler au professeur Quirrell.
...
Après que la serveuse eut fermé la porte derrière elle, le professeur Quirrell agita une main pour fermer le loquet, prononça les quatre sortilèges d'intimité habituels, et dit~: «~Une question intéressante, M. Potter.
...
Le professeur Quirrell but une gorgée d'eau.
«~Mais je digresse.
...
--- Il serait assez simple de lier les barrières de la Chambre à une phrase prononcée en Fourchelangue.
...
--- \parsel{Alors}, ssiffla le sserpent.
\parsel{Vous parlez, j'entends.
Je parle, vous entendez~?}

--- \parsel{Oui, je comprends,} ssiffla Harry.
\parsel{Vous êtes un Animaguss~?}

--- \parsel{Bien ssûr}, siffla le serpent.
\parsel{Trente-ssept règles, numéro trente-quatre~: Devenir un Animagus.
Tous les gens ssensés le font ss'ils en ssont capables.
Très rare, donc.}~» Les yeux du serpent étaient des surfaces plates logées dans des abysses noirs, des pupilles noires acérées au milieu d'espaces gris.
«~\parsel{C'esst le moyen de sse parler le pluss ssûr.
Voyez-vous pourquoi~?
Perssonne d'autre ne nous comprend.}

--- \parsel{Même ss'ils ssont des sserpents Animaguss~?}

--- \parsel{Pas à moins que l'héritier de Sserpentard ne le veuille.}~» Le serpent émit une série de courts sifflements que le cerveau de Harry traduit en un rire sardonique.
«~\parsel{Sserpentard pas sstupide.
Sserpent Animagus pas pareil que Fourchelangue.
Sserait énorme défaut dans le plan.}~»
...
«~\parsel{Je ne ssuis pas enregisstré}~», siffla le serpent.
Les abysses noirs fixaient Harry.
«~\parsel{Les Animagus doivent être enregisstrés.
La peine esst deux ans d'emprisonnement.
Garderez-vous mon ssecret, enfant~?}

--- \parsel{Oui,} siffla Harry.
\parsel{Ne briserai jamais promessse.}~»

Le serpent sembla rester immobile, comme sous l'effet d'un choc, puis il se remit à onduler.
«~\parsel{Nous reviendrons dans ssept jours.
Amenez cape pour passser ssans être vu, et ssablier pour déplaçcement dans le temps.}

--- \parsel{Vous ssavez~?} siffla Harry éberlué.
\parsel{Comment…}~»
...
--- \parsel{Laisssez tomber}, siffla Harry.
\parsel{Quesstion sstupide, oublié que vous étiez malin.}

--- \parsel{Sserait idiot de l'oublier,}~» dit le serpent, mais le sifflement ne révélait pas d'offense.

«~\parsel{Ssablier resstreint,} dit Harry.
\parsel{Ne peux pas utiliser avant neuvième heure.}~»

Le serpent se tordit le cou, un hochement de tête reptilien.
«~\parsel{Nombreuses resstrictions.
Utilisable sseulement par vous, ne peut être volé.
Ne peut transsporter d'autres humains.
Mais sserpent porté dans boursse viendra avec, je pensse.
Pensse posssible de tenir ssablier immobile dans coquille ssans sse faire repérer pendant que vous tournerez la coquille.
Tessterons dans ssept jours.
Ne parlerons pas de çce qui vient après.
Vous ne dites rien, à perssonne.
Ne donnez aucun ssigne d'attente, aucun.
Compriss~?~»}
...
--- \parsel{Oui.
Mais,}~» Harry émit un grincement vacillant que son esprit traduit par un «~Euuuuh~» hésitant, «~\parsel{Je ne promets pas de faire, quoi que çce ssoit, que vous n'avez pas dit…}~»

Le serpent eut un frisson que l'esprit de Harry traduit par un regard sévère.
«~\parsel{Bien ssûr que non.
En disscuterons à prochaine rencontre.}~»
...
--- Ou s'ils savaient que j'ai détruit un Détraqueur~», dit Harry, et il haussa les épaules.
