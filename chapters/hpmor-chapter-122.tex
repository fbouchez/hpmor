...
\lettrinepara{L}{e} soir passa, le matin vint.
Le dernier jour.
Le 15 juillet 1992.
...
Et oui, Harry avait maintenant son propre bureau à Poudlard.
...
Harry sortit la Baguette de Sureau de sa robe et regarda à nouveau le bois gris sombre que Dumbledore lui avait transmis.
...
«~Donc~», dit Hermione une fois que Harry l'eut laissée échapper à son étreinte.
...
Hermione se retourna et observa le ciel qui s'éclaircissait à l'est.
...
--- Je fais de mon mieux pour te soutenir dans tes choix, dit Harry d'un ton ferme.
Quels qu'ils soient.
...
Hermione parla avec précaution.
...
--- Ça s'annonce génial, dit Hermione Granger.
Je suis impatiente.
...
--- Oh, Harry,~» dit Hermione avec douceur.
Elle hésita.
...
Sur un toit pavé de dalles caillouteuses, l'étincelant soleil matinal illumine deux enfants qui n'en sont plus vraiment, tous deux en robe noire bordée de bleu, face à face, baguettes croisées.
