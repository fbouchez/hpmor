...
«~Vois-le comme ça~: tu rates un jour d'école, tu mens et tu dis au professeur que tu étais malade. Le professeur te dit d'amener un mot du docteur, alors tu en fabriques un. Le professeur dit qu'elle va appeler le docteur pour vérifier, alors tu dois lui donner un faux numéro et demander à un ami de faire semblant d'être le docteur quand elle appelle…
...
Et Harry siffla~: «~\parsel{Le directeur pensse que çc'est l'ançcien Sseigneur de çcette femme qui l'a volée à çcette prison.}~»
...
«~\parsel{Il pensse que çcelui-là esst en vie~?}~» répondit enfin le serpent. La langue bifide passa rapidement d'un côté à l'autre de sa bouche, rire reptilien sardonique. «~\parsel{Et pourtant je ne ssuis pas ssurpris.}

--- \parsel{Oui}, siffla Harry avec sécheresse. \parsel{très amusant, j'en ssuis ssûr. Ssauf que maintenant je ssuis coinçcé à Poudlard pendant les ssix prochaines années par mesure de ssécurité~! J'ai déçcidé que je vais bel et bien me mettre en quête de pouvoir~; et la sséquestratsion ne m'y aide pas beaucoup. Je dois convaincre le directeur que le Sseigneur des Ténèbres n'esst pas encore réveillé, que çcette évasion était l'œuvre d'une autre forçce…}~»

De nouveau l'oscillation rapide de la langue du serpent~; son rire était plus fort, plus sec cette fois.

«~\parsel{Bêtise d'amateur}.

--- \parsel{Comment~?} siffla Harry.

--- \parsel{Tu vois erreur, pensse à la défaire, à annuler çce qui a été fait. Mais même avec un ssablier le temps ne peut être défait. Mieux vaut avançcer. Tu pensses à convaincre les autres qu'ils ont tort. Bien pluss ssimple de les convaincre qu'ils ont raison. Conssidères çceci, garççon~: quel heureux hasard poussserait le maître de l'école à déçcider que tu es de nouveau en ssécurité et ferait ssimultanément avançcer tes autres projetss~?}~»

Harry regarda le serpent, perplexe. Son esprit essaya de comprendre, de dénouer l'énigme…

«~\parsel{N'esst-çce pas évident~?}~» siffla le serpent. De nouveau la langue qui oscillait, le rire sardonique. «~\parsel{Pour te libérer et gagner du pouvoir en Angleterre, on doit à nouveau te voir vaincre le Sseigneur des Ténèbres.}~»
...
--- \parsel{Quelque chose comme çça. La femme ssauvée coopérera, ssera des pluss convaincantes quand on la verra à sses côtés.}~» De nouveau l'oscillement lingual sardonique. «~\parsel{Tu te fais enlever de Poudlard, emmené vers lieu public, nombreux témoins, barrières pour empêcher protecteurs d'approcher. Sseigneur des Ténèbres annonçce qu'il a enfin retrouvé sson corps après avoir erré ssous forme d'essprit pendant des annéess~; dit que sson pouvoir esst pluss grand que jamais et que même toi ne pourras l'arrêter çcette fois-çci. Propose duel. Tu lances ssortilège gardien, Sseigneur des Ténèbres sse rit de toi, dit qu'il n'esst pas un mange-vie. Lançce ssort de mort vers toi, tu bloques, témoins voient le Sseigneur des Ténèbres exploser…}

--- \parsel{Lançcer ssort de mort~?} siffla Harry d'un ton incrédule. \parsel{Ssur moi~? Deuxième foiss~? Perssonne ne croira que le Sseigneur des Ténèbres sserait asssez bête pour…}

--- \parsel{Toi et moi ssommes les deux sseules personnes du pays qui l'auraient remarqué,} siffla le serpent. \parsel{Fais-moi confiançce ssur çce point, garççon.}

--- \parsel{Et ssi un jour il y en a une troisième~?}~»

Le serpent ondula pensivement. «~\parsel{Pourrons écrire autre sçcénario à jouer ssi tu ssouhaites. Quel qu'il ssoit, devrons laissser ouverte posssibilité que Sseigneur des Ténèbres revienne de nouveau -- pays doit pensser qu'ils dépendent toujours de toi pour les protéger.}~»
...
«~\parsel{Y pensserai,} siffla Harry. \parsel{Ne répondrai pas tout de ssuite çcette fois, énumérerai rissques et avantages avant…}

--- \parsel{Compris,} siffla le serpent. \parsel{Mais ssouviens-toi de çceçci, garççon, autres événements sse produisent ssans toi. Hésitation esst toujours facile, rarement utile.}~»
