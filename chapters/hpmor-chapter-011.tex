...
\textit{Note du traducteur: chapitre Omaké non revisité.}
...
Trelawney s'évente frénétiquement, Flitwick regarde avec curiosité, Hagrid applaudit au rythme de la musique, Chourave a l'air sévère et Quirrell regarde le garçon avec un amusement sardonique. À sa gauche, Dumbledore fredonne, et à sa droite, Rogue serre son gobelet de vin vide, les poings serrés, si fort que l'argent épais se déforme lentement.
...
--- \emph{J'ai eu à dire à des élèves qu'elles étaient mères -- ça te briserait le cœur de savoir ce que j'ai vu dans leurs esprits -- mais c'est la première fois que je dois dire à quelqu'un qu'il est père.}
