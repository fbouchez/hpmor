...
«~Ne refaites pas cela, s'il vous plaît, dit Harry.
...
Dumbledore fit un pas vers le portemanteau pendant que Harry finissait de traiter ces informations.
...
Dumbledore se tenait à côté de l'oiseau sur la plateforme dorée.
...
À peine Harry avait-il fini de pleinement consigner ces informations que, le poulet était déjà en feu.
...
Puis le feu mourut seulement quelques secondes après avoir commencé, laissant derrière un petit tas pathétique de cendres sur la plateforme dorée.
...
Le Serpentard intérieur de Harry hurla à s'en faire exploser les poumons mentaux, \shout{tais-toi idiot il va t'enlever à eux~!}

«~Non, non~», dit Harry, les lèvres livides figées en une grimace, «~j'essayais juste de vous épargner, en réalité ils sont très malfaisants…
