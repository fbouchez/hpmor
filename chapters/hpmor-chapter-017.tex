...
--- Alors, M. Potter, vous êtes autorisé à conserver le retourneur de temps pour le moment. Et étant donné la taille de la débâcle que vous avez, en effet, évitée, je ne déduirai pas de point à Serdaigle.~»
...
--- Je suis certaine, M. Potter, que ce n'est rien de très important.~» Le professeur McGonagall prononça ces mots très rapidement. «~Vous avez certainement entendu le directeur dire aux élèves de ne pas nous importuner avec des complaintes sans importance au sujet du professeur de Défense~?~»
