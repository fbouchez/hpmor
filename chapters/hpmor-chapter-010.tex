...
Je suis sûr que tu peux imaginer ce qui se passerait si tu courais en discuter avec tous les autres enfants en attente d'être Répartis.}

\emph{Si tu es placé sur la tête de n'importe qui que ne ferait ne serait-ce que} penser \emph{à la question de savoir si le Choixpeau est conscient de sa propre conscience…}

--- \emph{Oui, oui.
Mais la vaste majorité des enfants de onze ans qui arrivent à Poudlard n'ont pas lu Gödel, Escher et Bach.
Puis-je considérer que tu as juré le secret~?
...
Ses propres buts ne faisaient donc pas partie de “l'instance Harry” du Choixpeau, et donc… il empruntait son intelligence, et manifestement son vocabulaire technique, mais il était toujours imprégné de ses seuls propres buts étranges… c'était comme négocier avec un alien ou une intelligence artificielle…
...
\emph{«~Je sais que tu ne donneras pas suite à une menace de révéler ma nature, condamnant par là même ce moment à une éternelle répétition. Ça va trop à l'encontre de la partie morale de ta personne, quels que soient les besoins à court terme de la partie de toi qui veux remporter cette discussion. Je vois toutes tes pensées alors même qu'elles se forment, penses-tu vraiment pouvoir me bluffer~?}~»
