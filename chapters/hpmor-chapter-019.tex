...
Pour une raison ou une autre, le maître refusa.
...
Une fois que tous ses élèves eurent été tués ainsi, ce fut le tour du maître.
...
Lorsqu'il a semblé que vous risquiez de perdre, vous avez dégainé vos griffes, sans vous soucier du danger.
...
Vous n'en êtes qu'au cinquième jour de votre éducation à Poudlard et ceci s'est déjà produit.
...
«~Veuillez considérez cela comme un ordre de votre professeur, M. Potter.
Je tiens à préciser que dans le cas contraire, je ne vous enseignerai aucun sort offensif, parce que j'apprendrais alors que vous avez sévèrement blessé voire tué quelqu'un.
...
«~Professeur, si vous faites quoi que ce soit ressemblant à ce dont vous venez de parler, cela va me mettre en colère, et je ne voudrais vraiment pas me remettre en colère aujourd'hui…
...
--- Nous le ferons, dit Quirrell sur le ton de la promesse.
...
La douleur viendra de la difficulté à perdre, au lieu de riposter et intensifier le combat jusqu'à le gagner.~»

Harry ne respirait plus que par halètements courts et paniqués.
Il était plus effrayé que lorsqu'il avait quitté la classe de potions.
...
--- Professeur~», murmura Harry, dont la voix semblait être répétée partout, «~vous croyez vraiment que si je ne fais pas cela, je pourrais faire du mal à quelqu'un~?

--- Oui, dit simplement Quirrell.

--- Alors~», Harry se sentait nauséeux, «~je vais le faire.~»

Quirrell pivota pour faire face aux Serpentard.
«~Donc… avec l'approbation complète de votre enseignant, et de telle manière que Rogue ne pourra être blâmé pour vos actes… l'un ou l'une d'entre vous veut-il faire preuve de domination sur le Survivant~?
Le bousculer, le mettre au sol, l'entendre implorer votre pitié~?~»
...
Si Harry Potter devient le prochain Seigneur des Ténèbres, il vous pourchassera et vous tuera une fois ses études terminées.~»

Les cinq mains retombèrent promptement sur leur pupitre.
...
Je comprends que vous trouviez cela dérangeant, que vous projetiez de devenir le prochain Seigneur des Ténèbres ou non.
Mais ces enfants avaient \emph{aussi} une leçon de vie importante à apprendre.
...
--- Et quand j'aurai terminé mes études, je vous pourchasserai et je vous \emph{chatouillerai}.~»
...
«~Professeur, interpella Drago d'une voix non amplifiée, ce n'est pas non plus mon ambition que de devenir un Seigneur des Ténèbres stupide.~»

La classe fit silence, choquée.

\emph{Tu n'as pas à faire ça~!} faillit lâcher Harry, mais il se maîtrisa à temps~;
