...
Drago toucha le globe de cristal et la salle s'illumina d'une puissante lumière verte.
...
Puis il comprit, et il se redressa et s'éloigna du bureau d'un seul mouvement furieux.
C'en était trop.
C'était fini.
...
La créature étincelante disparut en un clin d'œil, car l'agitation qui montait en Drago l'empêchait de maintenir le sort.
...
Drago marcha jusqu'à son bureau, comme frappé de stupeur, et il s'assit assez vite pour que cela lui fasse légèrement mal.
...
\scream{Pourquoi, pourquoi, pourquoi} Harry Potter \scream{faisait-il} ce genre de choses…
...
Drago regardait Harry durement.
...
--- Alors on \emph{doit} être ennemis~?~»
...
--- Drago, tu \emph{dois} être capable de dire que les Mangemorts avaient tort sur certains points~!
...
--- \emph{\shout{Pourquoi~?} Pourquoi faut-il que tu sois toujours ainsi, Harry~?
Pourquoi faut-il que tu chamboules tout même quand c'est \shout{IMPOSSIBLE~?} Et arrête de sourire, ça n'est pas drôle~!}
...
--- Je ne pense pas que ça sera facile, dit Harry.
...
«~J'ai fait le rêve, dit la voix de Harry, qu'un jour, tous les êtres sentients\footnotemark{} seront jugés par les motifs de leur esprit et pas par la couleur ou la forme de la matière dont ils sont faits, ou par l'identité de leurs parents.
...
Drago ne savait plus, il ne savait plus où se trouvait la véritable force, ni ce qui était juste.
