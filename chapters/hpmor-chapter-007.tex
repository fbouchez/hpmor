...
Drago le regardait, dans l'expectative, et ils décapsulèrent leurs canettes au même moment.
...
«~Ça n'arrive pas toujours immédiatement, dit le vendeur. Mais ça arrive exactement une fois par canette, garanti ou remboursé.~»
...
«~\emph{Aaargh~!}~» cria Drago tandis Harry pulvérisait sur lui de sa bouche du liquide vert fluo.
Drago se tourna vers Harry, les yeux en feu, et attrapa sa propre sa canette.
«~Fils de sang-de-bourbe~! Voyons à quel point \emph{tu} aimes quand on te crache dessus~!~»
Drago prit délibérément une gorgée de la cannette juste au moment ses propres yeux tombaient sur la une du journal.
