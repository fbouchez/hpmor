...
La gare de King's Cross avait un quai numéro neuf (sur lequel ils se tenaient) et un quai numéro dix (juste à côté), mais il n'y avait absolument rien entre le quai numéro neuf et le quai numéro dix mis à part une mince barrière de protection peu prometteuse.
...
Harry n'avait fait que survoler rapidement ses livres d'école (et ça avait été un survol des plus étranges) pour tenter de déterminer le genre de livres scientifiques qu'il lui faudrait acheter durant les 48 prochaines heures.
...
(Et le temps supplémentaire que vous vous octroyiez déterminait si vous étiez consciencieux, ce qui était le second facteur le plus important de la réussite scolaire.)
...
--- Ah… Michel, très cher, il y a certaines choses avec lesquelles j'ai pensé qu'il serait mieux de ne pas t'embêter jusqu'à maintenant…
