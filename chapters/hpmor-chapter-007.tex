...
\lettrine{L}{es} lèvres de Pétunia Evans-Verres tremblaient et ses yeux larmoyaient, pendant que Harry la serrait dans ses bras sur le quai numéro neuf de la gare de King's Cross.
...
Il savait que la pensée était vraie, mais il ne savait pas pourquoi maman avait si peur.
...
La plupart des bouquins s'étaient vendus pour une livre sterling ou deux, mais pour certains ce n'étaient pas \emph{du tout} le cas, comme la toute dernière version du \emph{Handbook of Chemistry and Physics} ou l'ensemble complet de l'\emph{Encyclop\ae dia Britannica} 1972.
