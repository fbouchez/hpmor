\partchapter{L'Expérience de Prison de Stanford}{III}
...
«~\parsel{Montrez-lui votre visage,}~» siffla le serpent aux pieds de Harry.
...
«~La cicatrice… marmonna Bellatrix.
Cet enfant…
...
«~\parsel{Dites quelque chose en Fourchelangue}~», siffla le serpent.

Le visage de Harry se tourna vers le serpent afin de clairement montrer qu'il s'adressait à celui-ci, et il siffla~: «~\parsel{Un deux trois quatre çcinq ssix ssept huit neuf disx.}~»
...
«~\parsel{Sseront conssumés par elles.}
...
«~\parsel{Vous devrez la faire léviter jussqu'à la ssortie}, siffla Harry au serpent.
\parsel{Elle ne peut plus ssonger à ss'enfuir.}

--- \parsel{Oui}, siffla le serpent, \parsel{mais ne la ssous-esstimez pas.
Elle était la pluss mortelle des guerrières.}~» La tête verte s'inclina en signe d'avertissement.
«~\parsel{Il sserait ssage de me craindre, enfant, même ssi j'étais affamé et mort aux neufs dixièmess~; méfiez-vous d'elle, ne permettez à aucune faille d'apparaître dans votre jeu.}~»
...
Un autre mouvement de la baguette du serviteur fit flotter le squelette humain depuis le lit jusqu'aux airs, et presque du même mouvement, le corps fut recouvert d'une nouvelle robe noire.
