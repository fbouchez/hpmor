...
Il avait \emph{senti} la magie affluer dans son bras, et réalisé à cet instant qu'il avait toujours eu ce sens, qu'il l'avait possédé toute sa vie, le sens qui n'était ni la vue ni le son ni l'odorat ni le goût ni le toucher, mais seulement la magie.
...
Le choc s'était déversé en lui, venant effleurer plusieurs parties de son être, les réveillant, et avait disparu ensuite en quelques secondes~;
...
«~\emph{Il est en effet très curieux que vous soyez destiné à cette baguette, sachant que sa sœur, eh bien, sa sœur est responsable de votre cicatrice.}~»
...
qui rendait \emph{plus} probable d'une chance sur mille que Harry se retrouve avec la sœur de la baguette du Seigneur des Ténèbres, allait avoir un avantage.

McGonagall avait simplement dit \emph{comme c'est étrange} et en était restée là, ce qui avait mis Harry en état de choc face à la flagrante, à l'écrasante \emph{incuriosité} des sorciers et sorcières.
...
Puis les deux se turent, tandis qu'un homme vêtu d'amples habits oranges flottants apparaissait dans la rue et les dépassait lentement.
...
Le magasin de malles était plus richement décoré que tout les autres magasins que Harry avait vu de la journée~;
les rideaux étaient luxueux et ornés de motifs délicats, le sol et les murs en bois teinté et poli, et les malles occupaient les places d'honneur sur des estrades en ivoire poli.
...
«~La discipline \emph{doit} être respectée à Poudlard, dit-elle après qu'une minute entière se fut écoulée. Pour le bien de \emph{tous} les étudiants. Et cela \emph{doit} inclure la courtoisie et l'obéissance de votre part envers \emph{tous} les professeurs.~»
...
Harry s'inclina, et déposa le sac d'or et les onze gallions supplémentaires dans les mains de McGonagall.
