...
--- Vous pensez que j'ai été… Harry avait du mal à le dire, que j'ai été \emph{abusé}~?
...
McGonagall le regarda fixement. «~Il est de mon devoir en tant que directrice adjointe d'investiguer tout signe d'abus possible chez les enfants qui sont sous ma garde.~»

La colère de Harry tournoyait hors de contrôle, se transformant en pure fureur noire.
...
Une accusation comme celle-ci peut briser des gens et détruire des familles alors même que les parents sont totalement innocents~!
