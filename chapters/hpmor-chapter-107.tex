...
D'un mouvement du poignet, le professeur de Défense fit jaillir de sa baguette un liquide qui atteint la plante près de la base de ses tiges dans un bruit d'eau suivi d'un sifflement.
...
Harry se détourna et regarda la porte de l'autre côté de la salle.
...
Harry absorba cette contrainte supplémentaire.
...
Le professeur Quirrell ne bougea pas.
...
--- \parsel{Les mange-vie ne peuvent pas me détruire, je ne pensse pas,} siffla le professeur Quirrell.
\parsel{Et j'abandonnerais ssimplement çce corps ss'ils ss'approchent de trop près.
Çcette fois, je reviendrais très vite, et rien ne m'arrêterait.
Je torturerais tes parents pendant des années pour te punir de ne pas m'avoir aidé.
Des çcentaines d'élèves pris en otages mourraient, y compris çceux que tu dis être tes amis.
Maintenant, je te pose à nouveau la quesstion~: ss'ils venaient, utiliserais-tu ton pouvoir contre les mange-vie pour me protéger~?}
...
«~\parsel{Pourquoi, professeur Quirrell, pourquoi êtes-vous ainsi…}~»
