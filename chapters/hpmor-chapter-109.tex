...
«~\parsel{Est là}, répondit Harry dans un sifflement.
\parsel{Ne bouge pas.}~»
...
Au centre de l'envers d'or, une séquence de runes était apparue.
...
--- Lis-les quand même.
\parsel{Ne présente pas de danger.}
...
--- Waouh~», murmura Harry, et c'était sincère.
...
Le professeur Quirrell dit enfin~: «~J'ai peur d'avoir été trop malin pour mon bien.
...
Si tu as une autre idée et que je t'autorise à l'essayer, \parsel{je promets de ne jamais faire de mal aux pions que j’utiliserais, ni aujourd'hui, ni jamais~; et je ne m'attends pas à rompre cette promessse.} Et je te rappelle que les vies de Mlle Granger et de tous les autres dépendent de ma réussite.~»
...
--- Je ne sais pas pourquoi vous pensez qu'on peut résoudre cette énigme, dit Harry.
...
--- Mais comment en arriver là sans Légilimancie ou sortilège de Confusion, qui nécessitent tous deux des forces… ah.
Je \emph{vois}.~»
...
--- \parsel{Vous m'avez demandé de trouver une sstratégie, mais peut-être ai-je été influençcé par des buts annexses -- qui ssait~?
Je ssavais que vous me ssoupçonneriez, diriez ce que vous venez de dire.
Çc'est votre choix, professseur.
Ssur le rissque d'un échec, je n'en ssais pas pluss que vous.
Ne me traitez pas de traître si vous choisisssez d'esssayer et que çcela échoue.}~» Harry eut soudain très envie de sourire, mais il se retint.
...
«~Tu ne traverseras \emph{pas} le cercle après son activation, dit le professeur Quirrell.
...
«~\parsel{Cette barrière explosera ssi quoi que çce ssoit la touche.} La résonance m'atteindra peut-être ensuite, mais tu seras mort aussi.
